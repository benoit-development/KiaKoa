...
public class LoanListsDriveFile {
                            ...
                            new RetrieveDriveFileContentsAsyncTask(context) {
                                ...
                                protected void onPostExecute(String result) {
                                    ...
                                    if (LoanLists.fromJson(result, context)) {
                                        ...
                                        updateLoansJsonFileContent(driveId.asDriveFile());
                                    }
                                }
                            }.execute(driveId);
                        } else {
                        ...
                        .setResultCallback(new ResultCallback<DriveFolder.DriveFileResult>() {
                            ...
                            public void onResult(@NonNull DriveFolder.DriveFileResult driveFileResult) {
                                if (driveFileResult.getStatus().isSuccess()) {
                                    ...
                                    updateLoansJsonFileContent(driveFileResult.getDriveFile());
                                } else {
    ...
    /**
     * Update loans.json file with phone data
     *
     * @param driveFile file to update
     */
    private void updateLoansJsonFileContent(DriveFile driveFile) {
